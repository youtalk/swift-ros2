...
package func rclSerializeTemperature(_ value: Temperature) throws -> [UInt8] {
    var outBuf: UnsafeMutablePointer<UInt8>?
    var outLen: Int = 0
    let rc: Int32 = crcl_serialize_temperature(
...
extension Temperature: RclTypedPublishable {
    /// Marshal this Temperature into its rosidl C struct and publish
    /// via rcl_publish (crcl_publish_temperature).
